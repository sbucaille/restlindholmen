...
class MethodWrapper {
    ...
    static async getMethods(){
        return await httpGet('api/generics/method/allID', {});
    }

    static async getInfo(methodID){
        return await httpGet('api/generics/method/info', {methodID: methodID});
    }
...
class MethodParamWrapper {
    static async getMethodParams(){
        return await httpGet('api/generics/methodParam/allID', {});
    }

    static async getInfo(methodParamID){
        return await httpGet('api/generics/methodParam/info', {methodParamID: methodParamID});
    }
...
class RealizationWrapper {
    ...
    static async getRealizationsFromDiagram(diagramID) {
...
class GeneralizationWrapper {
    ...
    static async getGeneralizationsFromDiagram(diagramID) {
        return await httpGet('api/generics/realization/fromDiagram', {diagramID: diagramID});
    }
...
class UMLFileWrapper {
    ...
    static async getUmlFileFromDiagram(diagramID) {
        return await httpGet('api/generics/umlfile/fromDiagram', {diagramID : diagramID})
    }
}
